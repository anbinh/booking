			...
			<div class="login-block" >
				...
				<div class="form-fields-wrapper">
					<div class="pen-container">
						<div class= "row">
							  <a href="./twitterAuth" class="no-decoration" data-event-name="facebook log in attempt" ><span id="twitter"></span></a>
							  <a href="./fbauth" class="no-decoration" data-event-name="facebook log in attempt" ><span id="facebook"> </span></a>
							  <a href="./gauth" class="no-decoration" data-event-name="facebook log in attempt" ><span id="googleplus"></span></a>
						</div>
					</div>
