		...
		<div class="form-fields-wrapper" style = " max-width: 25em">
			<div class="pad-top">
				<div class="form-control-wrapper" style = "margin-bottom: 10%;" >
					<input style = "color: #009587; font-size: 110%;	margin-bottom: 5%;" type="email" class="form-control empty" data-hint="A valid email should contains @"><div class="hint">A valid email should contains @</div>
