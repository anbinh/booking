...
<!-- Mobile support -->
   ...
   <link href="{{ asset('home_page/css/material/bootstrap.min.css') }}" rel="stylesheet"> 
    ...
    <link href="{{ asset('home_page/css/material/ripples.min.css') }}" rel="stylesheet">
 	<!-- jQuery -->
    <script src="{{ asset('home_page/js/material/jquery-1.10.2.min.js') }}"></script>
    <!-- Dropdown.js -->
    <link href="{{ asset('home_page/css/material/jquery.dropdown.css') }}" rel="stylesheet">

    <!-- Twitter Bootstrap -->
    <script src="{{ asset('home_page/js/material/bootstrap.min.js') }}"></script>

    <!-- Material Design for Bootstrap -->
    <script src="{{ asset('home_page/js/material/material.min.js') }}"></script>
    <script src="{{ asset('home_page/js/material/ripples.min.js') }}"></script>
    <script>
      $.material.init();
    </script>
    ...
    <!-- Dropdown.js -->
    <script src="{{ asset('home_page/js/material/jquery.dropdown.js') }}"></script>
    <script>
...
<link href="{{ asset('home_page/css/font_manifest-15c87676a32319c4cbdb2a9c1e3f9eb2.css') }}" media="screen" rel="stylesheet" type="text/css" />


<link href="{{ asset('home_page/css/application.css?12') }}" media="all" rel="stylesheet" type="text/css" /> 
...
<link href="{{ asset('home_page/css/ng-dialog.min.css') }}" media="screen" rel="stylesheet" type="text/css" />


<!-- end head of hanny.com -->


<!--  <script src="{{ asset('home_page/js/jquery-2.0.2.min.js') }}"></script>
<link rel="stylesheet" href="{{ asset('home_page/css/jquery-2.0.2.min.css') }}">  -->
...
-->
        ...
        <!-- <script id="facebook-jssdk" src="{{ asset('home_page/js/all.js') }}"></script> -->
